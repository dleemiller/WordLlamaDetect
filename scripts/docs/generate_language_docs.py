...
def generate_language_docs(
    ...
    with open(output_path, "w") as f:
        ...
        # Table header
        if populations:
            f.write("| Language Code | FLORES Accuracy | FLORES F1 | Speakers |\n")
            f.write("|--------------|-----------------|-----------|----------|\n")
        else:
            f.write("| Language Code | FLORES Accuracy | FLORES F1 |\n")
            f.write("|--------------|-----------------|----------|\n")
        ...
        for lang_code, metrics in sorted_languages:
            ...
            if populations:
                ...
                f.write(f"| {lang_code} | {acc:.2%} | {f1:.4f} | {speakers} |\n")
            else:
                f.write(f"| {lang_code} | {acc:.2%} | {f1:.4f} |\n")
