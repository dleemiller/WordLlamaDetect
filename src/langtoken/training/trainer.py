...
from langtoken.config.models import TrainingConfig
from langtoken.data.flores import create_flores_dataset, get_flores_language_distribution
...
class LanguageDetectionDataset(Dataset):
    ...
    def __init__(
        ...
        self.logger = logger or logging.getLogger("langtoken")
