...
def save_lookup_table_e3m4(
    ...
    """Generate and save fp8_e3m4 lookup table with scaling.
    ...
    from wldetect.training.lookup_table import (
        save_lookup_table_e3m4 as save_lookup_table_e3m4_file,
    )

    logger.info("Generating fp8_e3m4 lookup table...")
    ...
    # Save as fp8_e3m4
    saved_path = save_lookup_table_e3m4_file(
        lookup_table_fp32=lookup_table,
        output_dir=output_dir,
        base_name="lookup_table",
